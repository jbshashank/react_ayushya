...
function fetchBrandsApi() {
    return axios.request({
        method: "get",
        url: `${BASE_URL_TICKETS}Employee/brands`,
    });
}
...
function fetchProductsApi() {
    return axios.request({
        method: "get",
        url: `${BASE_URL_TICKETS}Employee/products`,
    });
}
...
function fetchModelsApi(payload) {
    return axios.request({
       method: "get",
       url: `${BASE_URL_TICKETS}Employee/brands/${payload.brandId}/products/${payload.productId}/productsubcategory/${payload.productCategoryId}/models`,
   });
}
...
function fetchProductSubcategoryApi(payload) {
    return axios.request({
       method: "get",
       url: `${BASE_URL_TICKETS}Employee/brands/${payload.brandId}/products/${payload.productId}/productsubcategory`,
   });
}
